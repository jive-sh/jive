...
export const Publish: React.FC<{packageName: string, projectType: ProjectType}> = ({packageName }) => {
  ...
  React.useEffect(() => {
    ...
    run(`npx pnpm publish ${tarball} --tag ${tag}`, buildPath);
    setDone(true);
  }, []);
